...
select * from tanar where felhasznalo like 'domkos8545';
select * from tanar where nev like 'bako%';

update tanar set statusz = 2 where felhasznalo like 'zold169';
update tanar set funkcio = 2 where felhasznalo like 'domkos8545';
update tanar set funkcio = 3 where felhasznalo like 'dvid8910';
